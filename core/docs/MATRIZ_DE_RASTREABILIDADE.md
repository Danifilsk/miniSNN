...
| Contratos C7.1 | `minisnn_agent_io.h` | `src/agent_io.c` | `test-agent-io`, `check-c7` | schemas textuais, assinaturas e frames por tick | [Interface cerebro-agente](GUIA_DA_INTERFACE_CEREBRO_AGENTE.md) | Implementado; sem codificacao neural |
| Codificacao C7.2 | `minisnn_sensor_encoder.h` | `src/sensor_encoder.c`, `app/sensor_encoding_demo_config.c` | `test-sensor-encoder`, `scenario-sensor-encoding`, `check-c7` | frame neural, assinaturas, config fonte/efetiva, trace CSV e relatorio HTML | [Interface cerebro-agente](GUIA_DA_INTERFACE_CEREBRO_AGENTE.md) | Implementado; sem decodificacao ou dominio |
