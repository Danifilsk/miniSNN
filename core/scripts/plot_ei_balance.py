...
BASE_DIR = Path("results/experiments/ei_balance")

CSV_FILES = {
    "exc_neuron": BASE_DIR / "ei_exc_only_neuron2.csv",
    "exc_population": BASE_DIR / "ei_exc_only_population.csv",
    "balanced_neuron": BASE_DIR / "ei_balanced_neuron2.csv",
    "balanced_population": BASE_DIR / "ei_balanced_population.csv",
}

OUTPUT_FILES = [
    BASE_DIR / "ei_compare_voltage.png",
    BASE_DIR / "ei_compare_syn_current.png",
    BASE_DIR / "ei_compare_population_spikes.png",
]
